...
var CRITERION_ERRORS_STORE_DATA = {
    errors: [
        ...
        },
        {
            ...
            message: i18n.gettext("Time off duration cannot exceed employee average hours - {0}.")
        },
        {
            level: 1,
        ...
        {
            level: 1,
            code: "CAN_NOT_DELETE_SUBMITTED_EMPLOYEE_LIFE_EVENT",
            message: i18n.gettext("Can't delete life event. The life event has already been submitted.")
        },
        {
            level: 1,
        ...
        {
            level: 1,
            code: "EMPLOYEE_TAX_CODE_IS_NOT_VALID",
            message: i18n.gettext("Employee's tax code '{0}' is not valid!")
        },
        {
            level: 1,
            code: "BASIC_TAX_RATE_IS_NOT_CONFIGURED_FOR_UK",
            message: i18n.gettext("Basic tax rate is not configured for UK!")
        },
        {
            level: 1,
            code: "HIGHER_TAX_RATE_IS_NOT_CONFIGURED_FOR_UK",
            message: i18n.gettext("Higher tax rate is not configured for UK!")
        },
        {
            level: 1,
            code: "ADDITIONAL_TAX_RATE_IS_NOT_CONFIGURED_FOR_UK",
            message: i18n.gettext("Additional tax rate is not configured for UK!")
        },
        {
            level: 1,
        ...
        {
            level: 1,
            code: "CAN_NOT_ACCESS_EMPLOYEE_LIFE_EVENT_ATTACHMENT_FOR_EMPLOYEE_BY_SECURITY_PROFILES",
            message: i18n.gettext("Can't access employee life event attachment for employee '{0}'. Please check your security profiles.")
        },
        {
            level: 1,
        ...
        {
            level: 1,
            code: "RECRUITER_NOT_ASSIGNED_FOR_JOB_POSTING",
            message: i18n.gettext("Please, assign a Recruiter for Job Posting.")
        },
        {
            level: 1,
        ...
        },
        {
            ...
            message: i18n.gettext("Tenant with id '{0}' doesn't have password policy settings in the system.")
        },
        {
            level: 1,
            code: "TIME_OFF_REQUESTS_FOR_FUTURE_PERIOD_NOT_ALLOWED",
            message: i18n.gettext("Request {0} time off for the future period are not allowed.")
        },
        {
            level: 1,
            code: "PAYROLL_BATCH_CALCULATION_FOR_PAY_GROUP_CAN_BE_DONE_ONCE",
            message: i18n.gettext("Payroll batch '{0}' calculation for pay group '{1}' сan only be done once.")
        },
        {
            level: 1,
            code: "CANT_ADD_NEW_ASSIGNMENT_WITH_EFFECTIVE_DATE_EARLIER_THAN_CURRENT_ACTIVE",
            message: i18n.gettext("Can't add new assignment with effective date {0} for employee with number '{1}', because it's earlier than current active assignment '{2}' with effective date {3}.")
        }
    ]
};
