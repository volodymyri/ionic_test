/**
 * @class criterion.ux.calendar.CalendarPanel
 * @extends Ext.Panel
 ...
 * {@link #calendarStore} config containing records of type {@link criterion.ux.calendar.EventRecord EventRecord}. In order
 ...
 * @xtype calendarpanel
 */
Ext.define('criterion.ux.calendar.CalendarPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.calendarpanel',
    
    requires: [
        'Ext.layout.container.Card',
        'criterion.ux.calendar.view.Day',
        'criterion.ux.calendar.view.Week',
        'criterion.ux.calendar.view.Month',
        'criterion.ux.calendar.form.EventDetails',
     ...
     */
    dayText : i18n.gettext('Day'),
    /**
     * @cfg {String} weekText
     * Alternate text to use for the 'Week' nav bar button.
     */
    weekText : i18n.gettext('Week'),
    /**
     * @cfg {String} monthText
     * Alternate text to use for the 'Month' nav bar button.
     */
    monthText : i18n.gettext('Month'),
    /**
     * @cfg {boolean} highlightEventDay
     * If true add class to day box if highlightDayCls present in event.
     */
    highlightEventDay : false,
     ...
     * @param {criterion.ux.calendar.CalendarPanel} this
     * @param {criterion.ux.calendar.EventRecord} rec The new {@link criterion.ux.calendar.EventRecord record} that was added
     */
     ...
     * @param {criterion.ux.calendar.CalendarPanel} this
     * @param {criterion.ux.calendar.EventRecord} rec The new {@link criterion.ux.calendar.EventRecord record} that was updated
     */
     ...
     * @param {criterion.ux.calendar.CalendarPanel} this
     * @param {criterion.ux.calendar.EventRecord} rec The new {@link criterion.ux.calendar.EventRecord record} that was removed
     */
     ...
     * @param {criterion.ux.calendar.CalendarPanel} this
     * @param {criterion.ux.calendar.EventRecord} rec The new {@link criterion.ux.calendar.EventRecord record} that was canceled
     */
     ...
     * @param {criterion.ux.calendar.CalendarPanel} this
     * @param {Ext.criterion.ux.calendar.view.AbstractCalendar} view The view being activated (any valid {@link criterion.ux.calendar.view.AbstractCalendar AbstractCalendar} subclass)
    ...
    initComponent: function() {
        ...
        if (this.showMonthView) {
            var month = Ext.applyIf({
                ...
                showTodayText: this.showTodayText,
                showTime: this.showTime,
                highlightEventDay: this.highlightEventDay,
                listeners: {
                    'weekclick': {
                        fn: function(vw, dt) {
                            this.showWeek(dt);
    ...
    onEventAdd: function(form, rec) {
        rec.data[criterion.ux.calendar.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * @param {criterion.ux.calendar.EventRecord} record The event record to edit
     * @return {criterion.ux.calendar.CalendarPanel} this
     */
     ...
     * {@link criterion.ux.calendar.view.AbstractCalendar AbstractCalendar}.
     * @return {criterion.ux.calendar.view.AbstractCalendar} The active view
     */
