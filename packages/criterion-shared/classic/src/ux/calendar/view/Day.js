/**
 * @class criterion.ux.calendar.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link criterion.ux.calendar.view.AbstractCalendar AbstractCalendar}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link criterion.ux.calendar.DayHeaderView DayHeaderView} and a {@link criterion.ux.calendar.DayBodyView DayBodyView}. As such
 ...
 */
Ext.define('criterion.ux.calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.dayview',
    
    requires: [
        'criterion.ux.calendar.view.AbstractCalendar',
        'criterion.ux.calendar.view.DayHeader',
        'criterion.ux.calendar.view.DayBody'
    ],
