/**
 * @class criterion.ux.calendar.view.DayHeader
 * @extends criterion.ux.calendar.MonthView
 ...
 * which aggregates this class and the {@link criterion.ux.calendar.DayBodyView DayBodyView} into the single unified view
 * presented by {@link criterion.ux.calendar.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('criterion.ux.calendar.view.DayHeader', {
    extend: 'criterion.ux.calendar.view.Month',
    alias: 'widget.dayheaderview',

    requires: [
        'criterion.ux.calendar.template.DayHeader'
    ],
     ...
     * @param {criterion.ux.calendar.DayBodyView} this
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new criterion.ux.calendar.template.DayHeader({
                id: this.id,
