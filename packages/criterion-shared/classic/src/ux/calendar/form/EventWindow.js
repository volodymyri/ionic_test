/**
 * @class criterion.ux.calendar.form.EventWindow
 * @extends Ext.Window
 ...
 */
Ext.define('criterion.ux.calendar.form.EventWindow', {
    ...
    requires: [
        ...
        'criterion.ux.calendar.data.EventModel',
    ...
    constructor: function(config) {
        ...
        this.callParent([Ext.apply({
            ...
            resizable: false,
            buttonAlign: 'left',
            savingMessage : i18n.gettext('Saving changes...'),
            deletingMessage : i18n.gettext('Deleting event...'),
            layout: 'fit',
     ...
     * @param {criterion.ux.calendar.form.EventWindow} this
     ...
     * (by default, an instance of {@link criterion.ux.calendar.EventEditForm}. Handling code should hide this window
     * and transfer the current event record to the appropriate instance of the detailed form by showing it
     * and calling {@link criterion.ux.calendar.EventEditForm#loadRecord loadRecord}.
     * @param {criterion.ux.calendar.form.EventWindow} this
     * @param {criterion.ux.calendar.EventRecord} rec The {@link criterion.ux.calendar.EventRecord record} that is currently being edited
     */
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || criterion.ux.calendar.util.Date.add(start, {hours: 1});
            
            data[M.StartDate.name] = start;
            data[M.EndDate.name] = end;
            data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != criterion.ux.calendar.util.Date.add(end, {millis: 1}).getDate();
            rec = new criterion.ux.calendar.data.EventModel(data);
