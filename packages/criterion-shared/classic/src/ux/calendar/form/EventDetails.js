/**
 * @class criterion.ux.calendar.form.EventDetails
 ...
 * calendar components. It is also configured to automatically bind records of type {@link criterion.ux.calendar.EventRecord}
 ...
 */
Ext.define('criterion.ux.calendar.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.eventeditform',
    
    requires: [
        'criterion.ux.calendar.form.field.DateRange',
        'criterion.ux.calendar.form.field.ReminderCombo',
        'criterion.ux.calendar.data.EventMappings',
        'criterion.ux.calendar.form.field.CalendarCombo'
    ],
     ...
     * @param {criterion.ux.calendar.form.EventDetails} this
     ...
     * @param {criterion.ux.calendar.form.EventDetails} this
     * @param {criterion.ux.calendar.EventRecord} rec The new {@link criterion.ux.calendar.EventRecord record} that was deleted
     */
    ...
    initComponent: function() {
        this.titleField = new Ext.form.Text({
            ...
            name: criterion.ux.calendar.data.EventMappings.Title.name,
            emptyText : i18n.gettext('Event Title'),
            allowBlank: false,
            anchor: '90%'
        });
        this.dateRangeField = new criterion.ux.calendar.form.field.DateRange({
            fieldLabel : i18n.gettext('When'),
            singleLine: false,
            anchor: '90%'
        });
        this.reminderField = new criterion.ux.calendar.form.field.ReminderCombo({
            name: 'Reminder',
            anchor: '70%'
        });
        this.notesField = new Ext.form.TextArea({
            fieldLabel : i18n.gettext('Notes'),
            name: criterion.ux.calendar.data.EventMappings.Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.Text({
            ...
            name: criterion.ux.calendar.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel : i18n.gettext('Web Link'),
            name: criterion.ux.calendar.data.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new criterion.ux.calendar.form.field.CalendarCombo({
                store: this.calendarStore,
                anchor: '70%',
                name: criterion.ux.calendar.data.EventMappings.CalendarId.name
            });
        ...
        this.fbar = [{
            ...
            text : i18n.gettext('Delete Event'),
            scope: this,
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({
                'calendar': rec.data[criterion.ux.calendar.data.EventMappings.CalendarId.name]
            });
        }
