 ...
 */
Ext.define('criterion.ux.calendar.form.field.DateRange', {
     ...
     */
    getValue: function(){
        var eDate = criterion.ux.calendar.util.Date,
     ...
     * as defined in {@link criterion.ux.calendar.data.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(!v) {
            return;
        ...
        else if(v[criterion.ux.calendar.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[criterion.ux.calendar.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[criterion.ux.calendar.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[criterion.ux.calendar.data.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[criterion.ux.calendar.data.EventMappings.IsAllDay.name]);
        }
    },
