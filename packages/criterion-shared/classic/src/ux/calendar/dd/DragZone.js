 ...
 */
Ext.define('criterion.ux.calendar.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'criterion.ux.calendar.dd.StatusProxy',
    ...
    constructor: function(el, config) {
        if (!criterion.ux.calendar._statusProxyInstance) {
            criterion.ux.calendar._statusProxyInstance = new criterion.ux.calendar.dd.StatusProxy();
        }
        this.proxy = criterion.ux.calendar._statusProxyInstance;
    ...
    getDragData: function(e) {
        ...
        if (t) {
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[criterion.ux.calendar.data.EventMappings.StartDate.name],
                eventEnd: rec.data[criterion.ux.calendar.data.EventMappings.EndDate.name],
                proxy: this.proxy
            };
        }
