 ...
 */
Ext.define('criterion.ux.calendar.dd.DropZone', {
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = criterion.ux.calendar.util.Date.copyTime(rec.data[criterion.ux.calendar.data.EventMappings.StartDate.name], n.date);
