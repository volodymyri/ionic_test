 ...
 */
Ext.define('criterion.ux.calendar.dd.DayDropZone', {
    extend: 'criterion.ux.calendar.dd.DropZone',
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = criterion.ux.calendar.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = criterion.ux.calendar.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || criterion.ux.calendar.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = criterion.ux.calendar.util.Date.copyTime(n.date, this.resizeDt);
                start = criterion.ux.calendar.util.Date.min(data.eventStart, curr);
                end = criterion.ux.calendar.util.Date.max(data.eventStart, curr);
