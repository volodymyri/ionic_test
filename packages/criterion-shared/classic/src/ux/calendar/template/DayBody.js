/**
 * @class criterion.ux.calendar.template.DayBody
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link criterion.ux.calendar.DayView DayView} and
 * {@link criterion.ux.calendar.WeekView WeekView}. This template is automatically bound to the underlying event store by the
 ...
 * that internally creates an instance of this template along with a {@link criterion.ux.calendar.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('criterion.ux.calendar.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = criterion.ux.calendar.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = criterion.ux.calendar.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            times.push(Ext.Date.format(dt, criterion.consts.Api.SHORT_TIME_FORMAT));
            dt = criterion.ux.calendar.util.Date.add(dt, {hours: 1});
        }
