/**
 * @class criterion.ux.calendar.template.Month
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link criterion.ux.calendar.template.Month MonthView}. Internally this class defers to an
 ...
 */
Ext.define('criterion.ux.calendar.template.Month', {
    ...
    constructor: function(config){
        ...
        this.weekTpl = new criterion.ux.calendar.template.BoxLayout(config);
    ...
    applyTemplate : function(o){
        var days = [],
            ...
            dt = o.viewStart,
            D = criterion.ux.calendar.util.Date;
