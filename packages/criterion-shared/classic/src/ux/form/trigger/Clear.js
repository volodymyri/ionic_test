/**
 * @class criterion.ux.form.trigger.Clear
 *
 ...
 *          2.0</a>.
 */
Ext.define('criterion.ux.form.trigger.Clear', {
    ...
    /**
     * @cfg {Boolean} Hides the clear trigger when the field is readOnly
     *      (default: true).
     */
    hideOnReadOnly : true,
    ...
    initEvents : function() {
        ...
        if (Ext.isDefined(cmp.clearTriggerHidden)) {
            this.addManagedListener(cmp, 'clearhiddenchange', this.updateTriggerVisibility, this);
        }
    ...
    onClick: function() {
        ...
        if (handler && (!field.readOnly || !field.hideOnReadOnly) && me.isFieldEnabled()) {
    ...
    isTriggerVisible : function() {
        ...
        if (this.hideOnReadOnly && Ext.isDefined(this.field.readOnly) && this.field.readOnly) {
            return false;
        }
        ...
        return Ext.isDefined(this.field.clearTriggerHidden) ? !this.field.clearTriggerHidden : true;
    }
