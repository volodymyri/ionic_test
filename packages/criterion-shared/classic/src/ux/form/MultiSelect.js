 ...
 */
// TODO We should remove this component and start using Sencha's ItemSelector
Ext.define('criterion.ux.form.MultiSelect', {
    ...
    alternateClassName : ['criterion.ux.Multiselect'],
    alias : ['widget.criterion_multiselectfield', 'widget.criterion_multiselect'],
     ...
     */
    minSelectionsText : i18n.gettext('Minimum {0} item(s) required'),
     ...
     */
    maxSelectionsText : i18n.gettext('Maximum {0} item(s) required'),
     ...
     */
    dragText : i18n.gettext('{0} Item{1}'),
