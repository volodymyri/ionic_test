Ext.define('criterion.view.ess.career.Education', function() {

    return {

        alias : 'widget.criterion_selfservice_career_education',

        extend : 'criterion.view.person.Education',

        requires : [
            'criterion.controller.ess.career.Education',
            'criterion.vm.workflow.Base'
        ],

        controller : {
            type : 'criterion_selfservice_career_education'
        },
